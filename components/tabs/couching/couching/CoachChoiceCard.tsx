...
export const CoachChoiceCard = () => {
  return (
    <View style={styles.container}>
      <View style={styles.badge}>
        <Text style={styles.badgeText}>COACH'S CHOICE</Text>
      </View>
      
      <View style={styles.card}>
        <View style={styles.productInfo}>
          <Image 
            source={{ uri: 'https://cdn.shopify.com/s/files/1/0533/0845/7140/products/stick-pack-1_800x.png?v=1614343202' }} // Replace with actual asset
            style={styles.productImage} 
          />
          <View style={styles.details}>
            <Text style={styles.productTitle}>AFORCE STICK</Text>
            <Text style={styles.productSub}>BEFORE WORKOUT FUEL</Text>
...
const styles = StyleSheet.create({
  container: { marginTop: moderateScale(20), marginBottom: moderateScale(40) },
  ...
  productTitle: { color: 'white', fontSize: moderateScale(20), fontWeight: '900' },
